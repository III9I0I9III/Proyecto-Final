...
const opciones = [
  { valor: "Flor", imagen: "/IMG-C/flor.jpg", tipo: "monosílaba" },
  { valor: "Casa", imagen: "/IMG-C/casita.jpg", tipo: "bisílaba" },
  { valor: "Mariposa", imagen: "/IMG-C/mariposa.jpg", tipo: "trisílaba" },
];

const sonidoCorrecto = new Audio("/Sonidos-C/correcto.mp3");
const sonidoIncorrecto = new Audio("/Sonidos-C/incorrecto.mp3");

const EjercicioLenguaje1 = ({ onPuntuar }) => {
  const [respuesta, setRespuesta] = useState("");
  const [mensaje, setMensaje] = useState("");
  const [puntajeDado, setPuntajeDado] = useState(false);

  const verificarRespuesta = () => {
    if (respuesta === "trisílaba") {
      sonidoCorrecto.play();
      setMensaje("✅ ¡Correcto! Mariposa tiene 4 sílabas, es polisílaba.");
      ...
      setMensaje("❌ Incorrecto. La palabra correcta es: Mariposa.");
    }
  };

  return (
    <div className="p-4">
      <h2 className="text-xl font-bold mb-2">Ejercicio 1: Clasificación de palabras</h2>
      <p>¿Cuál de estas palabras es una palabra polisílaba?</p>
...
export default EjercicioLenguaje1;
