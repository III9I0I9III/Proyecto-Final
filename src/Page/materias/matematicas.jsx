...
import Ejercicio1 from "../ejercicios/Matematicas/EjercicioMatematica1.jsx";
import Ejercicio2 from "../ejercicios/Matematicas/EjercicioMatematica2.jsx";
import Ejercicio3 from "../ejercicios/Matematicas/EjercicioMatematica3.jsx";
import Ejercicio4 from "../ejercicios/Matematicas/EjercicioMatematica4.jsx";
...
function Matematicas() {
  ...
  const salir = () => {
    ...
    const mensaje = `🧮 Tu nota en Matemáticas es: ${nota}/10\n${mensajeFinal()}`;
    alert(mensaje);
  ...
  const mensajeFinal = () => {
    ...
    if (nota === 10) return "🏆 ¡Perfecto! Eres un genio de las matemáticas.";
    if (nota >= 7) return "🎯 ¡Muy bien! Solo algunos pequeños errores.";
    if (nota >= 5) return "📚 Buen trabajo, pero hay conceptos que reforzar.";
    return "⚠️ Necesitas practicar más los ejercicios.";
  };
  ...
  const renderEjercicio = () => {
    ...
    switch (paso) {
      ...
      case 5:
        return (
          <div className="text-center p-8 bg-white rounded-3xl shadow-2xl border-4 border-indigo-400 max-w-md mx-auto transform transition-all hover:scale-105">
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-4 px-6 rounded-2xl mb-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-red-100 p-4 rounded-xl border-2 border-red-300">
                <p className="text-red-800 font-bold text-xl">✖️ {respuestasIncorrectas.length}</p>
                <p className="text-red-600">Incorrectas</p>
              </div>
            </div>
            <div className="bg-gradient-to-r from-indigo-400 to-purple-500 p-3 rounded-xl shadow-md">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 p-6 flex flex-col justify-center items-center">
      {/* Feedback flotante */}
      {mostrarFeedback && (
      ...
      <div className="w-full max-w-4xl">
        ...
        {/* Tarjeta principal */}
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border-2 border-white hover:border-indigo-300 transition-all duration-300">
          ...
          <div className="p-8">
            ...
            {paso === TOTAL_EJERCICIOS + 1 && (
              <div className="flex justify-center gap-6 mt-8">
                <button
                  onClick={reiniciar}
                  className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2"
                >
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Academia de Matemáticas - Todos los derechos reservados</p>
        </div>
      </div>
    </div>
  );
